...
ip route add 10.0.0.0/8 via 10.12.1.4 dev ens256
ip route add 200.0.0.0/24 via 10.12.1.4 dev ens256
...
conf t
 ...
 router ospf 1
  ...
  exit
 ip name-server 10.12.1.10   !8.8.8.8 8.8.4.4
 ip domain lookup
...
Review: Create a DNS A record for www.ccna12.com
